...
public class UserMapperTest {
    ...
    public void testInsert() {
        UserDO user = new UserDO().setUsername(UUID.randomUUID().toString())
                .setPassword("plus0").setCreateTime(new Date())
    ...
    public void testUpdateById() {
        UserDO updateUser = new UserDO().setId(8)
                .setPassword("plus2");
    ...
    public void testSelectByUsername() {
        UserDO yunai = userMapper.selectByUsername("b2562a7b-6f26-4de9-ade1-d41eca26c90c");
        System.out.println("nicai = " + yunai);
    }

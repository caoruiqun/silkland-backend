package com.caoruiqun.springwebsocket.websocket;

import com.alibaba.fastjson2.JSON;
import com.alibaba.fastjson2.JSONObject;
import com.caoruiqun.springwebsocket.handler.MessageHandler;
import com.caoruiqun.springwebsocket.message.AuthRequest;
import com.caoruiqun.springwebsocket.message.Message;
...
public class WebsocketServerEndpoint implements InitializingBean {
     ...
     */
    private static final Map<String, com.caoruiqun.springwebsocket.handler.MessageHandler> HANDLERS = new HashMap<>();
    ...
    public void onOpen(Session session, EndpointConfig config) {
        ...
        // 获得消息处理器
        com.caoruiqun.springwebsocket.handler.MessageHandler<AuthRequest> messageHandler = HANDLERS.get(AuthRequest.TYPE);
    ...
    public void onMessage(Session session, String message) {
        ...
        try {
            ...
            // 获得消息处理器
            com.caoruiqun.springwebsocket.handler.MessageHandler messageHandler = HANDLERS.get(messageType);
            if (messageHandler == null) {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        applicationContext.getBeansOfType(com.caoruiqun.springwebsocket.handler.MessageHandler.class).values() // 获得所有 MessageHandler Bean
                .forEach(messageHandler -> HANDLERS.put(messageHandler.getType(), messageHandler)); // 添加到 handlers 中
        logger.info("[afterPropertiesSet][消息处理器数量：{}]", HANDLERS.size());
    }

    private Class<? extends Message> getMessageClass(com.caoruiqun.springwebsocket.handler.MessageHandler handler) {
